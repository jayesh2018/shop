    ...
    <div class="form-group">
     ...
     <!--  <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="text" name="rcode" class="form-control" id="example-tel-input" value=<?php echo $code ?>>
      </div>

     <div class="col text-center">
      <button type="submit" name="submit" class="btn btn-outline-success btn-lg" aria-pressed="true">Register</button>
