...
<form class="mt-3 p-3" method="post" action="validate.php">
    <div class="form-group">
      ...
      <button type="submit" name="submit"  class="btn btn-outline-success btn-lg" aria-pressed="true"  >Login</button>
      <button type="button"  onclick="location.href='Register.php'" class="btn btn-outline-success btn-lg" >Sign Up</button>
      </div>
</form>
