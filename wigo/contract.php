...
if ($_SESSION['user_id'] != '' || $_SESSION['user_id'] != null) {
    ...
    if ($my_money < 100) {
        ...
        echo '<script>location.href="Wigo.php";</script>';
    } else if (isset($_POST['room']) && isset($_POST['money']) && isset($_POST['choice']) && isset($_POST['number'])) {
        $room = $_POST['room'];
        ...
        if ($my_money < $amount) {
            ...
            $query = "INSERT INTO `purchased`(`room`,`money`,`choice`, `customer_id`) VALUES ('$room','$amount','$choice', '$customer_id')";
            echo $query;
